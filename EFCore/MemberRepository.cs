...
public class MemberRepository : IMemberRepository
{
    ...
    public async Task<Member> GetMemberByUsernamePasswordAsync(string username, string password) => await _dbContext.Member.Where(m => m.UserName == username && m.Password == password).SingleOrDefaultAsync();
